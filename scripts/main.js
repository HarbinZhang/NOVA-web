...
NOVA.prototype.loadMessages = function() {
  // TODO(DEVELOPER): Load and listens for new messages.
    ...
    var setMessage = function(data) {
        var val = data.val();
        this.displayMessage(data.key, val.curtID);
    }.bind(this);
...
NOVA.prototype.displayMessage = function(key, name) {
  ...
  var messageElement = div.querySelector('.users');

  messageElement.textContent = "ceshi";
